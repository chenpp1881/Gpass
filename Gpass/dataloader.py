...
class ProofStepsData(Dataset):
    ...
    def __init__(self, split, opts):
        ...
        print('%d proof steps in %s' % (len(self.proof_steps), split))
...
def create_dataloader(split, opts):
    ...
    return DataLoader(ds, opts.batchsize, shuffle=False, collate_fn=merge)

if __name__ == '__main__':
    opts = parse_args()
    loader = create_dataloader('train', opts)
    print(loader)
    # bar = ProgressBar(maxval=len(loader))
