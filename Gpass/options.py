...
def parse_args():
    ...
    parser.add_argument('--exp_id', type=str,default='tok')
    # parser.add_argument('--datapath', type=str, default='proof_steps/human')
    parser.add_argument('--datapath', type=str, default='../proof_step')
    ...
    parser.add_argument('--no_validation', action='store_true', help='no validation is performed',default=False)
    parser.add_argument('--save_model_epochs', type=int, default=1, help='the number of epochs between model savings')
    parser.add_argument('--num_workers', type=int, default=1, help='the number of data-loading threads')
